...
def load_squad_dataset(dataset):
    ...
    print('Total long answer data: ', num_of_long_answer)
    print('Total short answer data: ', num_of_short_answer)
...
if __name__ == "__main__":
    ...
    df_train.to_csv(dataset_save_path + 'squad_train_short.csv', index=False)
    df_train_long.to_csv(dataset_save_path + 'squad_train_long.csv', index=False)
    df_validation.to_csv(dataset_save_path + 'squad_validation_short.csv', index=False)
